...
table.insert(BIS_LINKS, 
    { Faction = "Alliance",  RaceId = nil , ClassId = CLASS_ID, PhaseId = PHASE_ID, MaxPhaseId = 9, SpecId = SPEC_ID, InvSlotId = INV_SLOT_ID, Priority = 5, ItemId = 744, PVPRank = 0 }    
);

table.insert(BIS_LINKS, 
    { Faction = "Alliance",  RaceId = nil , ClassId = CLASS_ID, PhaseId = 3, MaxPhaseId = 9, SpecId = SPEC_ID, InvSlotId = INV_SLOT_ID, Priority = 6, ItemId = 19289, PVPRank = 0 }    
);


table.insert(BIS_LINKS, 
    { Faction = nil,  RaceId = nil , ClassId = CLASS_ID, PhaseId = PHASE_ID, MaxPhaseId = 9, SpecId = SPEC_ID, InvSlotId = INV_SLOT_ID, Priority = 7, ItemId = 13515, PVPRank = 0 }    
);

table.insert(BIS_LINKS, 
    { Faction = nil,  RaceId = nil , ClassId = CLASS_ID, PhaseId = PHASE_ID, MaxPhaseId = 9, SpecId = SPEC_ID, InvSlotId = INV_SLOT_ID, Priority = 8, ItemId = 13171, PVPRank = 0 }    
);
